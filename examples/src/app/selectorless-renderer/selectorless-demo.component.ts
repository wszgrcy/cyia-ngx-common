...
import {
  ...
  // 辅助组件 (用于获取选择器)
  SExcludedComp as SE1,
  SBeforeComp as SB1,
  SMultiFirstComp as SMF1,
  SMultiMiddleComp as SMM1,
  SMultiLastComp as SML1,
  SCTComp1Comp as SCt1,
  STCComp1Comp as STc1,
  STagCompTag1Comp as SCT1,
  SMultiTagCompComp as STM,
  SNestedTagCompComp as STN,
  SAltC1Comp as SAC1,
  SAltC2Comp as SAC2,
  SMultiChildCompComp as SMC,
  SMixedContentCompComp as SMTX,
  SDeepNestedCompComp as SDN,
  SForCompComp as SFC,
  SIfCompComp as SIFC,
  SSwitchCompComp as SSWC,
  SOuterNestedExcludedComp as SOE,
  SInnerNestedExcludedComp as SIE,
  SMixedExcludedComp as SME,
  SContentOutletComp as SCO,
  SSDynamicComp as SDY,
  SSDStaticComp as SST,
  SCTt1Comp,
  STCt1Comp,
  SCTDComp,
  SDTCComp,
